"""ginlix-data implementation of PriceDataProvider."""
...
# Yahoo Finance / FMP symbol → Polygon.io symbol for major indices
...
class GinlixDataPriceProvider:
    """Price data provider backed by ginlix-data REST API."""
    ...
    @staticmethod
    def _polygon_index_symbol(symbol: str) -> str:
        """Convert a Yahoo/FMP-style index symbol to Polygon.io format."""
    ...
    async def get_intraday(
        ...
        api_symbol = self._polygon_index_symbol(symbol) if is_index else symbol
